...
let id = req.params.id;
    User.findById(id, {}, {}, (err, contactItemToEdit) => {
        if (err) {
            console.error(err);
            res.end(err);
        }
        displayName: req.body.username
        //return res.render('index', { title: 'contact', page: 'contact-list', displayName: UserDisplayName(req) });        
        return res.render('contact-list',{displayName: req.body.username});
        // show the edit view
